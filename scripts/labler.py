...
class AmharicNERLabeler:
    def __init__(self):
        ...
        self.price_keywords = ['ዋጋ', 'ብር','ዝቅተኛዋጋ', 'ታክስ', 'ትልቅዋጋ']
        self.location_list = [
            'አዲስ', 'የታይላንድ', 'ቦሌ', 'ቡልጋሪ', 
            'በረራ', 'ልደታ', 'ባልቻ', 'አአ','ጎንደር', 'ደሴ', 'ሲዳማ', 'ሜሴክ', 'ከተማ', 'ጂማ'
        ] 
        self.product_keywords = [ 
             'ቀሚስ', 'ጫማ', 'ካሜራ', 'ቡናመፍጫ', 'መቀመጫ', 'መጥበሻነጣ', 'መሳሪያ', 'እቃ', 'ኮምፒዩተር','ምርት', 'ስቶቭ', 'ማንኪያ', 'የችበስመጥበሻ','መጽሐፍ',
    ...
    def label_tokens(self, tokens):
        ...
        for i, token in enumerate(tokens):
            ...
            if 'ዋጋ' in token_stripped and 'ብር' in token_stripped a:
                labels.append('I-PRICE')  # Label as I-PRICE
                continue
            
            # Step 6: Check if the current token contains "ከ" and "ብር"
            if 'ከ' in token_stripped and 'ብር' in token_stripped and 'ታክስ' in token_stripped:
                labels.append('I-PRICE')  # Label as I-PRICE
                continue
